...
public class ProductController : ControllerBase
{
  ...
  // ฟังก์ชันสร้าง Constructor รับค่า ApplicationDbContext
            ...
            [FromQuery] int? selectedCategory=null)
    {
        ...
        // var products = _context.products.Where(p => p.unitinstock >= 10).ToList();  //แบบมีเงื่อนไข

        // แบบเชื่อมกับตารางอื่น products เชื่อมกับ category
